...
const links = [
  {
    label: "GitHub",
    href: "https://github.com/annan92419",
    Icon: GitHubIcon,
    display: "annan92419",
  },
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/jesse-annan97",
    Icon: LinkedInIcon,
    display: "jesse-annan97",
  },
  {
    label: "Email",
    href: "mailto:jesann404@gmail.com",
    Icon: ({ size }: { size?: number }) => <Mail size={size} />,
    display: "jesann404@gmail.com",
  },
];
